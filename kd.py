...
# # classifier = Classifier(hyperparameters_seal)
...
# print("Testing Student before KD")
# student_model.eval()
# val_loss,hits = loop_dataset(val_graphs, student_model, list(range(len(val_graphs))),evaluator)
# if not hyperparameters_seal.printAUC:
#     val_loss[2] = 0.0
# print('\033[93maverage validation of epoch %d: loss %.5f acc %.5f auc %.5f hits@20 %.5f hits@50 %.5f hits@100 %.5f\033[0m' % (
#     0, val_loss[0], val_loss[1], val_loss[2],hits[0],hits[1],hits[2]))
# val_watermark_loss = None
# test_loss,hits = loop_dataset(test_graphs, student_model, list(range(len(test_graphs))),evaluator)
# if not hyperparameters_seal.printAUC:
#     test_loss[2] = 0.0
# print('\033[94maverage test of epoch %d: loss %.5f acc %.5f auc %.5f hits@20 %.5f hits@50 %.5f hits@100 %.5f\033[0m' % (
#     0, test_loss[0], test_loss[1], test_loss[2],hits[0],hits[1],hits[2]))
...
#             train_graphs, teacher_model, student_model, train_idxes, evaluator,optimizer=optimizer, bsize=args.batch_size
#         )
